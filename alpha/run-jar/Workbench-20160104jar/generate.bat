set classpath=.\generate\java-lib\xalan.jar;.\generate\java-lib\xml-apis.jar;.\generated\java-lib\xercesImpl.jar;.\generate\java-lib\serializer.jar;.\generate\java-lib\transform.jar
