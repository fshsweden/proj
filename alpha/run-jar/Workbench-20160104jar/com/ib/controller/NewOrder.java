...
//	private int m_basisPointsType;     // EFP orders only, download only
	...
	public String toString() {
		...
		str.append("Client Id:"); str.append(m_clientId);
		str.append("\nOrder ID Id:"); str.append(m_orderId);
		str.append("\nPerm Id:"); str.append(m_permId);
		str.append("\nParent Id:"); str.append(m_parentId);

		// primary attributes
		str.append("\nAccount:"); str.append(m_account);
		str.append("\nAction:"); str.append(m_action);
		str.append("\nTot Qty:"); str.append(m_totalQuantity);
		str.append("\nDispQty:"); str.append(m_displaySize);
		str.append("\nOrd Type:"); str.append(m_orderType);
		str.append("\nLmt Prc:"); str.append(m_lmtPrice);
		str.append("\nAux prc:"); str.append(m_auxPrice);
		str.append("\nTif:"); str.append(m_tif);
