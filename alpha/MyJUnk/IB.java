...
import mytrade.common_if.ExecutionEventHandler;
import mytrade.common_if.Instrument;
import mytrade.common_if.KeyValues;
import mytrade.common_if.MarketPriceEventHandler;
import mytrade.common_if.Order;
import mytrade.common_if.OrderAction;
import mytrade.common_if.OrderEventHandler;
import mytrade.common_if.OrderState2;
import mytrade.common_if.OrderType;
import mytrade.common_if.TimeInForce;
import test_ib.IBOrder;

public class IB implements Market, IConnectionHandler {
...
//	private List<StrategyServer_OwnTrade>	strategyserver_trades	= new ArrayList<StrategyServer_OwnTrade>();
	...
	public void downloadOrders(final OrderEventHandler oeh) {
		...
		apiController.takeTwsOrders(new ILiveOrderHandler() {
			...
			@Override
			public void openOrder(NewContract contract, NewOrder newOrder, NewOrderState orderState) {
...
*/			
	...
	public int subscribeToInstrument(Instrument i, MarketPriceEventHandler meh) {
		...
		// NewContract con = instr_t
				
		NewContract con = new NewContract();
	...
	public void placeOrder(Instrument ib, Double price, Integer size, Action action) {
		...
		NewOrder newOrder = ibOrder.getNewOrder();
