...
public class Forum implements ListSelectionListener {
    ...
    private void addComponentsToPane(Container pane) {
        ...
        tableScroll = new JScrollPane(dialogTable, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        ...
        Runnable doRun1 = new Runnable() {
            ...
            public void run() {
                ...
                for (int row = 0; row < 30; row++) {
                    ...
                    // Important to have data for all columns!
    ...
    private class myTableModel extends AbstractTableModel {
        ...
        private boolean[] _columnsVisible = {true, true, true, true, true, true, true, true, true};
